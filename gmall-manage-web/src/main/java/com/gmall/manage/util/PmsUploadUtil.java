...
public class PmsUploadUtil {
    ...
    public static String uploadImage(MultipartFile multipartFile) {
        ...
        try {
            ...
            String attrName = originalFilename.substring(originalFilename.lastIndexOf(".")+1);

            String[] uploadInfos = storageClient.upload_file(bytes, attrName, null);
